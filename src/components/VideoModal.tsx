...
export const VideoModal: React.FC<VideoModalProps> = ({ isOpen, onClose, lang }) => {
  ...
  // Auto-close modal when the user scrolls down/up
  useEffect(() => {
    if (!isOpen) return;
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-slate-950/80 backdrop-blur-md font-sans">
        ...
        >
          ...
          <div className="relative aspect-video bg-black flex items-center justify-center overflow-hidden group">
            ...
            >
              <source
                src="https://cdn.coverr.co/videos/coverr-cleaning-a-glass-window-5441/1080p.mp4"
                type="video/mp4"
              />
              <source
                src="https://assets.mixkit.co/videos/preview/mixkit-woman-cleaning-a-table-in-an-office-41561-large.mp4"
                type="video/mp4"
              />
              {lang === 'de' 
            ...
            <div className="absolute top-3 right-3 bg-black/60 backdrop-blur-md px-3 py-1 rounded-full text-[10px] font-semibold text-slate-200 border border-white/10 pointer-events-none">
